...
<head>
    ...
    <title>Mise à jour a partir d'une version precedente &mdash; scolaricx 1.0 documentation</title>
    ...
    <link rel="next" title="Mise à jour from 1.0 to beta 1.1" href="upgrade_11.php" />
    <link rel="prev" title="Telecharger scolaricx" href="downloads.php" />
                ...
                <div class="rst-content">
                    <div role="navigation" aria-label="breadcrumbs navigation">
                        <ul class="wy-breadcrumbs">
                            ...
                            <li><a href="index.php">Instruction d'installation</a> &raquo;</li>

                            <li>Mise à jour a partir d'une version precedente</li>
                    ...
                    <div role="main" class="document">
                        ...
                        <div class="section" id="upgrading-from-a-previous-version">
                            <h1>Mise à jour a partir d'une version precedente<a class="headerlink"
                                    href="#upgrading-from-a-previous-version" title="Permalink to this headline">¶</a>
                            </h1>
                            <p>s'il vous plait lisez les notes de mises à jour correspondantes à la version à partir de
                                laquelle vous faites la mise à jour.
                                Please read the upgrade notes corresponding to the version you are
                                upgrading from.</p>
                            <div class="toctree-wrapper compound">
                                <ul>
                                    <li class="toctree-l1"><a class="reference internal" href="upgrade_b11.php">Mise à
                                            jour from Beta 1.0 to Beta 1.1</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
                        ...
                        <a href="upgrade_b11.php" class="btn btn-neutral float-right"
                            title="Mise à jour from 3.1.5 to 1.0">Next <span
                                class="fa fa-arrow-circle-right"></span></a>


                        <a href="downloads.php" class="btn btn-neutral" title="Telecharger scolaricx"><span
