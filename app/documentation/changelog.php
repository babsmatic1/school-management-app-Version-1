...
<head>
    ...
    <title>Change Log &mdash; scolaricx 1.0 documentation</title>
    ...
    <link rel="next" title="The MIT License (MIT)" href="license.php" />
                ...
                <div class="rst-content">
                    ...
                    <div role="main" class="document">
                        ...
                        <div class="section" id="change-log">
                            <h1>Change Log<a class="headerlink" href="#change-log"
                                    title="Permalink to this headline">¶</a></h1>
                            <div class="section" id="version-beta-1-0">
                                <h2>Version Beta 1.0<a class="headerlink" href="#version-beta-1-0"
                                        title="Permalink to this headline">¶</a></h2>
                                <p>Release Date: Jully 31, 2022</p>
                    ...
                    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
                        ...
                        <a href="license.php" class="btn btn-neutral float-right" title="The MIT License (MIT)">Next
