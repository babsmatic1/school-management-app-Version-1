...
<head>
    ...
    <title>Scolaricx User Guide &mdash; Scolaricx 1.0 documentation</title>
    ...
    <link rel="top" title="Scolaricx 1.0 documentation" href="#" />
    <link rel="next" title="Bienvenue to Scolaricx" href="general/welcome.php" />
    ...
    <div class="wy-grid-for-nav">
        ...
        <nav data-toggle="wy-nav-shift" class="wy-nav-side">
            <div class="wy-side-nav-search">
                ...
                <a href="#" class="fa fa-home"> Scolaricx</a>
                ...
                <div class="rst-content">
                    ...
                    <div role="main" class="document">
                        ...
                        <div class="section" id="codeigniter-user-guide">
                            ...
                            <div class="contents local topic" id="contents">
                                <ul class="simple">
                                    <li><a class="reference internal" href="#welcome" id="id1">Bienvenue</a></li>
                            ...
                            <div class="section" id="welcome">
                                <h2><a class="toc-backref" href="#id1">Bienvenue</a><a class="headerlink"
                                        href="#welcome" title="Permalink to this headline">¶</a></h2>
                                <div class="toctree-wrapper compound">
                                    <ul>
                                        <li class="toctree-l1"><a class="reference internal"
                                                href="general/welcome.php">Bienvenue chez Scolaricx</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="toctree-wrapper compound">
                                    <ul>
                                        <li class="toctree-l1"><a class="reference internal"
                                            ...
                                            <ul>
                                                <li class="toctree-l2"><a class="reference internal"
                                                        href="tutorial/static_pages.php">Installer et
                                                        Configurer</a></li>
                                                <li class="toctree-l2"><a class="reference internal"
                    ...
                    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
                        ...
                        <a href="general/welcome.html" class="btn btn-neutral float-right"
                            title="Bienvenue to Scolaricx">Next <span class="fa fa-arrow-circle-right"></span></a>
