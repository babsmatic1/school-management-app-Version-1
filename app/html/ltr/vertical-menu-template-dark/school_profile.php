                                                            ...
                                                            <form class="form" action="" method="post">
                                                                <div class="card collapse-header">
                                                                    ...
                                                                    <div id="collapse300<?php echo $i ?>" class="collapse" aria-labelledby="heading300<?php echo $i ?>" data-parent="#accordionExample3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <button class="btn btn-danger float-right" type="submit" name="migrate">Promote checked</button>
                                                                            <button class="btn btn-success float-right" type="submit" name="migrate_all">Promote All</button>
                                                                        </div>
                                                                    </div>
                                                            </form>
                                                        <?php
