                    ...
                    <hr>
                        ...
                        <div class="col-11">
                            <center>
                                ...
                                <span style="font-size: 20px;">
                                    <h6><b><i><?php echo htmlspecialchars_decode ($location) ?></i> <!-- Campus de Douala / Village, face PICASO --></i></b></h6>

                                </span>
                                <span style="font : cursive 20px">
                                    <h6><b><i> Email: <i><?php echo "$email_s "?> telephone :<strong><?php echo $tel ?> web :</strong><?php echo $web ?> <strong> <?php echo $tel ?>.</strong></i></b></h6>
                                </span>
